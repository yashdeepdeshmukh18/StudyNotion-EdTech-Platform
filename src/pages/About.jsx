...
import FoundingStrory from '../assets/Images/FoundingStory.png'
...
const About = () => {
  return (
    <div className='mx-auto w-10/12 mt-[100px] text-white'>
        {/* section 1 */}
        <section>
            <div>
                <header>
                    ...
                    <p>Studynotion is at the forefront of driving innovation in online education. We're passionate about
        ...
        <section>
            <div className='flex flex-col'>
                ...
                <div className='flex'>
                    ...
                    <div>
                        <img src={FoundingStrory}/>
                    </div>
                </div>

                {/* mission and vision wala div */}
                <div className='flex'>
                    {/* left box */}
                    <div>
                        <h1>Our vision</h1>
                    ...
                    <div>
                        ...
                        <p>our mission goes beyond just delivering courses online. We wanted to create a vibrant community of learners, where individuals can connect,
                         collaborate, and learn from one another. We believe that knowledge thrives in an environment of sharing and dialogue, and we foster this spirit of
